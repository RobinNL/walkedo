        ...
        <main>
            ...
            <div className={'container'}>
                ...
                <div className={Styles.heroIntroBlock}>
                    ...
                    <p>
                        Heb je een hond nodig met het uiterlijk van een wolf voor je productie, film, muziekvideo, foto
                        of marketing campagne? Walkedo kan je helpen met de Northern Inuit Dog.
                        Deze honden hebben een hele aantrekkelijke look omdat ze op een wolf lijken. Zo zijn ze ook
                        gebruikt bij de productie van de TV Series Game Of Thrones.
                    </p>
                    <p>
                        De Northern Inuit Dog is goed getraind en zijn ideaal voor
                        producties waarbij je een fantasy of middeleeuwse richting op wilt. Ze hebben een lief karakter
                        en kunnen dit ook uitstralen, maar indien nodig kunnen ze ook vijandig en scherp uit de ogen
                        kijken.
            ...
            <div className={Styles.carouselBanner}>
                ...
                >
                    ...
                    {/*</div>*/}
                    <div className={Styles.carouselImage}>
                        <Image src={'/images/casting/koda-wolf-casting-walk.jpg'} fill={true} objectPosition={'center'}
                               alt={'Wolf uiterlijk voor casting, lopend door het bos'}/>
                    </div>
                    <div className={Styles.carouselImage}>
                        <div className={Styles.carouselImage}>
                            <Image src={'/images/casting/koda-northerninuit-highfive hond-3.jpg'} fill={true}
                                   objectPosition={'center'} alt={'Wolf achteraanzicht weglopend samen met roodkapje'}/>
                        </div>
                    </div>
                    <div className={Styles.carouselImage}>
                        <Image fill={true} objectPosition={'center'} src={'/images/casting/koda-portret-wegkijkend.jpg'}
                               alt={'Wolf uiterlijk voor casting, wegkijkend van de camera'}/>
                    </div>
                    <div className={Styles.carouselImage}>
                        <Image fill={true} objectPosition={'center'}
                               src={'/images/casting/roodkapje-koda-samensmelting.jpg'}
                               alt={'Wolf uiterlijk samen met roodkapje'}/>
                    </div>
                    ...
                    {/*</div>*/}
                    <div className={Styles.carouselImage}>
                        <Image src={'/images/casting/northern-inuit-wolf-casting-solo-portret.jpg'} fill={true}
                               objectPosition={'center'} alt={'Northern Inuit dog die als wolf poseert in het bos'}/>
                    </div>
                </Carousel>;
            </div>
